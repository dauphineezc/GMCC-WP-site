/**
 * Archived Careers page UI.
 *
 * Nav/footer now link straight to ADP (`ADP_LANDING_PAGE_URL`).
 * Kept here so we can restore `/careers` later — rename to `page.tsx`
 * (and remove the redirect in the current `page.tsx`) to bring it back.
 */
