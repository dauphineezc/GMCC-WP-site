...
export default function PoolAvailabilityPage() {
  ...
  return (
    <main>
        ...
        <p className="text-neutral-700 text-xl mt-0 mb-4">Please review the pool rules before visiting the pool.</p>
        <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm w-2/3">
            <ul className="list-disc pl-5 text-base text-neutral-700">
                ...
                <li>People with open sores, rashes, unhealed wounds, or infectious conditions not permitted</li>
            ...
            <p className="text-italic text-neutral-700 text-xl mt-4 mb-0">All other policies provided in the Greater Midland Handbook.</p>
        </div>
