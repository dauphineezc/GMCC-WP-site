...
/**
 * Footer wave is painted as navy over the page (body is white), not on a white
 * box. A white underlay behind the SVG shows through anti-aliased bottom edges
 * as a hairline above the navy band on mobile.
 */
export default function Footer({ items }: FooterProps) {
  return (
    <footer className="relative text-white pt-8">
      <div className="relative z-[1] -mb-[6px] w-full leading-none">
        ...
        <div
          className="pointer-events-none absolute bottom-0 left-0 h-[6px] w-full bg-gmcc-navy"
          aria-hidden
        />
      </div>

      <div className="relative -mt-[6px] bg-gmcc-navy pt-8 md:pt-12">
